        ...
        [FromQuery] string? search = null)
        {
            ...
            var items = await query
                ...
                .Select(wi => new WarehouseItemDto
                {
                    ...
                    Quantity = Math.Round(wi.Quantity, 3),
                    Withdrawn = Math.Round(wi.Withdrawn, 3),

                    PricePerUnit = Math.Round(wi.PricePerUnit, 2),

                    TotalValue = Math.Round(wi.Quantity * wi.PricePerUnit, 2),
                    RemainingQuantity = Math.Round(wi.Quantity - wi.Withdrawn, 3),
